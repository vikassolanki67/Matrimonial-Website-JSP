...
public final class user_002dprofile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    if ("exists".equals(mess)) {
      ...
      out.write("\n");
      out.write("        <div class=\"alert-soft alert-soft-danger mb-3\"><i class=\"bi bi-exclamation-circle-fill\"></i><span>Already Requested</span></div>\n");
 }
    if ("success".equals(mess)) {

      out.write("\n");
      out.write("        <div class=\"alert-soft alert-soft-success mb-3\"><i class=\"bi bi-exclamation-circle-fill\"></i><span>Requeste send</span></div>\n");
 }
 ...
 request.setAttribute("pageTitle", name + " — Vivaah Circle"); 
      ...
      out.write(".jpg\" alt=\"");
      out.print( name );
      out.write("'s profile photo\" onerror=\"this.onerror=null;this.src='assets/images/default-profile.svg';\">\n");
      out.write("        </div>\n");
      out.write("        <h1>");
      out.print( name );
      out.write("</h1>\n");
      ...
      out.write("                    <a href=\"search_record.jsp\" class=\"btn btn-outline-brand flex-fill text-center\" onclick=\"history.back();return false;\"><i class=\"bi bi-arrow-left\"></i> Back to Results</a>\n");
      out.write("                    <a href=\"search.jsp\" class=\"btn btn-brand flex-fill text-center\"><i class=\"bi bi-search\"></i> New Search</a>\n");
      out.write("                    ");
 if (relStatus == null || "-1".equals(relStatus) || "-2".equals(relStatus)) { 
      out.write("\n");
      out.write("                        <a href=\"interested_process.jsp?id=");
      out.print( usercode );
      out.write("\" class=\"btn btn-brand flex-fill text-center\">Interested</a>\n");
      out.write("                    ");
} else if ("0".equals(relStatus) && logincode.equals(relFromCode)) {
      out.write("\n");
      out.write("                        <a href=\"request_action.jsp?id=");
      out.print( usercode );
      out.write("&action=withdraw&from=profile\" class=\"btn btn-outline-brand flex-fill text-center\">Cancel Request</a>\n");
      out.write("                    ");
} else if ("0".equals(relStatus)) {
      out.write("\n");
      out.write("                        <a href=\"request_action.jsp?id=");
      out.print( usercode );
      out.write("&action=accept&from=profile\" class=\"btn btn-brand flex-fill text-center\">Accept</a>\n");
      out.write("                        <a href=\"request_action.jsp?id=");
      out.print( usercode );
      out.write("&action=decline&from=profile\" class=\"btn btn-outline-brand flex-fill text-center\">Reject</a>\n");
      out.write("                    ");
 } else if ("1".equals(relStatus)) { 
      out.write("\n");
      out.write("                        <a href=\"request_action.jsp?id=");
      out.print( usercode );
      out.write("&action=cancel&from=profile\" class=\"btn btn-outline-brand flex-fill text-center\">Disconnect</a>\n");
      out.write("                        <a href=\"message.jsp?id=");
      out.print( usercode );
      out.write("class=\"btn btn-outline-brand flex-fill text-center\">Message</a>\n");
      out.write("                    ");
 } 
      out.write("\n");
      out.write("                </div>\n");
