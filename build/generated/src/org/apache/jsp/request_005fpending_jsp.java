...
public final class request_005fpending_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 request.setAttribute("pageTitle", name + " — Vivaah Circle"); 
      ...
      out.write("\n");
      out.write("                        <p class=\"text-muted mb-0\">No extra photos.</p>\n");
      out.write("                        ");
      ...
      out.print( usercode );
      out.write("&action=accept\" class=\"btn btn-brand flex-fill text-center\"><i class=\"bi bi-check-lg\"></i> Accept</a>\n");
      out.write("                    <a href=\"request_action.jsp?id=");
      out.print( usercode );
      out.write("&action=decline\" class=\"btn btn-outline-brand flex-fill text-center\"><i class=\"bi bi-x-lg\"></i> Reject</a>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
